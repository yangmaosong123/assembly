<template>
<div>
     <el-dialog ref="dialog" @close="close" title="组件修改" :visible.sync="show" :close-on-click-modal="false" width="60%">
    <div>
     ...
     <div slot="footer" class="dialog-footer">
         <el-button type="primary" @click="pre" v-show="this.active==1 ||this.active==2 || this.active==3">上一步</el-button>
        <el-button type="primary" @click="next" v-show="showBtn">{{content}} </el-button>
